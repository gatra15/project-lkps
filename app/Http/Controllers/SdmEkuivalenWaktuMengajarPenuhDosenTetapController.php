...
class SdmEkuivalenWaktuMengajarPenuhDosenTetapController extends Controller
{
    ...
    public function create(Request $req)
    {
        ...
        return redirect('/profil-dosen/ewmp')->with('success', 'New Dosen EWMP has been created.');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, SdmEkuivalenWaktuMengajarPenuhDosenTetap $sdmEkuivalenWaktuMengajarPenuhDosenTetap)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(SdmEkuivalenWaktuMengajarPenuhDosenTetap $sdmEkuivalenWaktuMengajarPenuhDosenTetap)
    {
        //
    }
}
