...
class CreateSimulasiPenilaiansTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('simulasi_penilaians', function (Blueprint $table) {
            ...
            $table->float('point_6_akhir')->nullable(true);
            $table->float('point_7a')->nullable(true);
            $table->float('point_7b')->nullable(true);
            $table->float('point_7_akhir')->nullable(true);
            ...
            $table->float('point_9_akhir')->nullable(true);
            ...
            $table->float('point_15_akhir')->nullable(true);
            $table->float('point_16a')->nullable(true);
            $table->float('point_16b')->nullable(true);
            $table->float('point_16_akhir')->nullable(true);
            ...
            $table->float('point_31_akhir')->nullable(true);
            ...
            $table->float('point_38_akhir')->nullable(true);
            ...
            $table->float('point_40_akhir')->nullable(true);
            ...
            $table->float('point_41_akhir')->nullable(true);
            ...
            $table->float('point_44_akhir')->nullable(true);
            ...
            $table->float('point_47_akhir')->nullable(true);
