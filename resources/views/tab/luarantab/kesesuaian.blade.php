<div class="tab-pane fade show" id="kesesuaian" role="tabpanel" aria-labelledby="kesesuaian-tab">
    <p class="d-flex justify-content-between">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalkesesuaian">
            Tambah data
        </button>
    </p>
    ...
    <div class="modal fade" id="modalkesesuaian" tabindex="-1" aria-labelledby="modalkesesuaian" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="modalkesesuaian">Tambah Data Dosen Industri </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
            @include('partials.luarancapaianmodal.kesesuaian')
        </div>
        </div>
        </div>
