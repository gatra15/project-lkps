<div id="print-table4">
    ...
    @endhasanyrole
        ...
        @hasrole('asesor')   
            ...
            @foreach ($efektifitasPrestasi['data_asesor'] as $key => $ts)
            <tr>
                <td>{{ $key == sizeof($efektifitasPrestasi['data_asesor'])-1 ? 'TS-3' : 'TS-'.(sizeof($efektifitasPrestasi['data_asesor'])+2-$key) }}</td>
                <td>{{ $ts->jumlah_mahasiswa }}</td>
                <td ></td>
                <td ></td>
                <td ></td>
