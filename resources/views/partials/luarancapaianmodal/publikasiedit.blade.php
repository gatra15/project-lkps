        ...
        <div class="card-body px-20 pb-20">
            <div class="row">
                ...
                <div class="input-group input-group-sm mb-3">
                    <input type="hidden" name="media_id" value="#" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" readonly>
                </div>
                ...
                <div class="form-row justify-content-center text-center">
                    ...
                    <label for="dosentetap"> TS-2 :</label>
                      <input name="#" value="#" class="form-control form-control-sm mb-3" type="number" min="1" required>
                    </div>
                    <div class="form-group col-md-4 align-middle">
