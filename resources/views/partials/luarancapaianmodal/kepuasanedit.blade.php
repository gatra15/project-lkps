            ...
            <div class="row">
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-4 align-middle">
                      ...
                      <input type="text" class="form-control form-control-sm mb-6" name="mahasiswa_aktif_ts_2" id="#" >
                    </div>
                    <div class="form-group col-md-4 align-middle">
                      <label for="#">Baik</label>
                      <input type="text" class="form-control form-control-sm mb-6" name="mahasiswa_aktif_ts_1" id="#">
                    </div>
                    <div class="form-group col-md-4 align-middle">
                      <label for="#">Cukup</label>
                      <input type="text" class="form-control form-control-sm mb-6" name="mahasiswa_aktif_ts" id="#">
                    </div>
                    <div class="form-group col-md-4 align-middle">
